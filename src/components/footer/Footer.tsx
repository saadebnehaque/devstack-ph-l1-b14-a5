...
const Footer = () => {
    ...
    return (
        <footer className='border-t border-base-300 pt-8 lg:pt-16 pb-12 '>
            <div className='container mx-auto space-y-3 lg:space-y-14'>
                <div className=' lg:grid grid-cols-5 gap-10'>
                 ...
                 flex-col items-center lg:items-start gap-4'>
                        ...
                        <p className=' text-gray-500 text-xs leading-5'>Curated tools, technologies, and resources for developers building modern software.</p>
                    ...
                    </div>
                    {
                        footLinks.map((footLink: FootLinkType, i) =>
                            <div key={i} className='hidden lg:block'>
                                ...
                                <ul className=' text-gray-500 text-xs space-y-2.5 '>
                                    {footLink.links.map(link =>
                                        <li key={link.name}><a href={link.path} className='hover:underline hover:text-gray-600'>{link.name}</a></li>
                                    )}
                                </ul>
                            </div>)
                    }
                </div>
                <div className='text-xs text-gray-500 flex items-center justify-between pt-4 lg:pt-8 px-6 lg:px-0 border-t border-base-300'>
                    <span>© 2026 Dev Stack. All rights reserved.</span>
                    <ul className='flex items-center gap-2 lg:gap-6'>
                        <li className='hover:underline hover:text-gray-600'><a href="">Privacy</a></li>
                        <li className='hover:underline hover:text-gray-600'><a href="">Terms</a></li>
                    </ul>
                </div>
            </div>
        </footer>
