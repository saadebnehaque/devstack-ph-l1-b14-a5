            ...
            <div className="navbar bg-base-100 shadow-sm sticky z-10 top-0">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            ...
                            {
                                menus.map(menu => <li className=' hover:text-[#DB2777] font-semibold active:bg-white'><a>{menu}</a></li>)
                            }
                        </ul>
                    </div>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
                        {
                            menus.map(menu => <li className=' hover:text-secondary font-semibold'><a>{menu}</a></li>)
                        }
                    </ul>
                </div>
